...
*/
//布局列表
export const LAYOUTLIST = BASE + "api/pageCreator/layout/list";

//获取布局设置
export const GETLAYOUTSETTING = BASE + "api/pageCreator/layout/get";

//保存布局
export const SAVELAYOUT = BASE + "api/pageCreator/layout/save";

//删除布局
export const DELETELAYOUT = BASE + "api/pageCreator/layout/delete";
...
*/
//获取组件列表
export const COMPONENTLIST = BASE + "api/pageCreator/component/list";

//保存组件参数设置信息
export const SAVEPARAMETER = BASE + "api/pageCreator/component/saveParam";
...
*/
//获取页面列表
export const GETPAGELIST = BASE + "api/pageCreator/pageInfo/list";

//保存页面
export const SAVEPAGE = BASE + "api/pageCreator/pageInfo/save";

// 删除页面
export const DELTEPAGE = BASE + "api/pageCreator/pageInfo/delete";

// 复制页面
export const COPYPAGE = BASE + "api/pageCreator/pageInfo/copy";
...
*/
//获取页面
export const GETPAGE = BASE + "api/pageCreator/pageInfo/get";
...
// 获取样式列表
export const GETTHEMELIST = BASE + "api/pageCreator/systemStyle/list";

// 删除样式
export const DELETETHEME = BASE + "api/pageCreator/systemStyle/delete";

// 保存样式
export const SAVETHEME = BASE + "api/pageCreator/systemStyle/save";

// 获取样式设置信息
export const EDITETHEME = BASE + "api/pageCreator/systemStyle/get";

// 发布页面
export const PUBLISH = BASE + "api/pageCreator/pageInfo/publish";
